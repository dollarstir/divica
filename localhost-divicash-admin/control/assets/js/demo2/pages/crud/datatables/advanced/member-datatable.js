			...
			columnDefs: [
				...
				},
				{
					...
					render: function(data, type, full, meta) {
                        ...
                        <a href="#" data-toggle="modal" data-target="#kt_modal_4" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Details">
				...
				},
				{
					...
					render: function(data, type, full, meta) {
						var status = {
							1: {'title': 'Pearl', 'class': 'kt-badge--danger'},
							2: {'title': 'Sapphire', 'class': ' kt-badge--brand'},
							3: {'title': 'Ruby', 'class': ' kt-badge--primary'},
							4: {'title': 'Emerald','class': 'kt-badge--success'}
						};
